 ...
 */
package com.github.acticfox.jpf.processor;
...
/**
 * Processes {@link Extension} annotations and generates an {@link ExtensionStorage}. You can specify the concrete
 * {@link ExtensionStorage} via processor's environment options ({@link ProcessingEnvironment#getOptions()}) or system
 * property. In both variants the option/property name is {@code pf4j.storageClassName}.
 *
 * @author Decebal Suiu
 */
public class ExtensionAnnotationProcessor extends AbstractProcessor {
    ...
    private List<TypeElement> findExtensionPoints(TypeElement extensionElement) {
        ...
        AnnotationValue annotatedExtensionPoints =
        ...
        List<? extends AnnotationValue> extensionPointClasses = (annotatedExtensionPoints != null)
            ? (List<? extends AnnotationValue>)annotatedExtensionPoints.getValue() : null;
