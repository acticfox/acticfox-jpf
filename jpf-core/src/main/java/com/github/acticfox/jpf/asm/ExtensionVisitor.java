 ...
 */
package com.github.acticfox.jpf.asm;
...
/**
 * This visitor extracts an {@link ExtensionInfo} from any class, that holds an {@link Extension} annotation.
 * <p>
 * The annotation parameters are extracted from byte code by using the <a href="https://asm.ow2.io/">ASM library</a>.
 * This makes it possible to access the {@link Extension} parameters without loading the class into the class loader.
 * This avoids possible {@link NoClassDefFoundError}'s for extensions, that can't be loaded due to missing dependencies.
 *
                ...
                if ("ordinal".equals(name) || "plugins".equals(name) || "points".equals(name)) {
                    return new AnnotationVisitor(ASM_VERSION, super.visitArray(name)) {
                        ...
                        public void visit(String key, Object value) {
                            log.debug("Load annotation attribute {} = {} ({})", name, value,
