...
import com.github.acticfox.jpf.util.FileUtils;

/**
 * Default implementation of the {@link PluginManager} interface. In essence it is a {@link ZipPluginManager} plus a
 * {@link JarPluginManager}. So, it can load plugins from jar and zip, simultaneous.
 *
 * <p>
...
public class DefaultPluginManager extends AbstractPluginManager {
    ...
    protected PluginDescriptorFinder createPluginDescriptorFinder() {
        return new CompoundPluginDescriptorFinder().add(new PropertiesPluginDescriptorFinder())
    ...
    protected PluginStatusProvider createPluginStatusProvider() {
        ...
        Path configPath = configDir != null ? Paths.get(configDir) : getPluginsRoots().stream().findFirst()
    ...
    protected void initialize() {
        ...
        log.info("PF4J  in '{}' mode", getRuntimeMode());
    }
