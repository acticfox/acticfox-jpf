...
public class DefaultPluginDescriptor implements PluginDescriptor {
    ...
    public DefaultPluginDescriptor(String tenantId, String pluginId, String pluginDescription, String pluginClass,
    ...
    /**
     * Returns all dependencies declared by this plugin. Returns an empty array if this plugin does not declare any
     * require.
     */
    @Override
    ...
    public String toString() {
        return "PluginDescriptor [pluginId=" + pluginId + ", pluginClass=" + pluginClass + ", version=" + version
            + ", provider=" + provider + ", dependencies=" + dependencies + ", description=" + pluginDescription
            + ", requires=" + requires + ", license=" + license + ", tenantId=" + tenantId + "]";
    }

    protected DefaultPluginDescriptor setTenantId(String tenantId) {
        this.tenantId = tenantId;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(tenantId, that.tenantId) && Objects.equals(pluginId, that.pluginId)
            ...
            && Objects.equals(requires, that.requires) && Objects.equals(provider, that.provider)
            && dependencies.equals(that.dependencies) && Objects.equals(license, that.license);
    }

    @Override
    public int hashCode() {
        return Objects.hash(tenantId, pluginId, pluginDescription, pluginClass, version, requires, provider,
